...
/**
 * GearApplication
 * Created by YichenZ on 2016/5/16 14:57.
 */
public final class GearCompositeSubscription implements Subscription {
    private Set<Subscription> subscriptions;
    private volatile boolean unsubscribed;
    private Context mContext;

    public GearCompositeSubscription() {
    }

    public GearCompositeSubscription(Context context) {
        mContext=context;
    }

    public GearCompositeSubscription(final Subscription... subscriptions) {
     ...
     * <p>After call of this method, new {@code Subscription}s added to {@link GearCompositeSubscription}
